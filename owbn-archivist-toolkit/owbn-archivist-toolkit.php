...
add_action( 'admin_init', array( 'OAT_Page_Coordinator_Review', 'maybe_handle' ) );
...
// Chronicle Report → targeted Coordinator email on approval.
OAT_Chronicle_Report_Notify::init();

// Global workflow notifications (all domains except chronicle reports):
// approve/deny → originator, request-changes → the level it went back to.
OAT_Workflow_Notify::init();
